...
[![CRAN status](https://www.r-pkg.org/badges/version/wnbaherstory)](https://CRAN.R-project.org/package=wnbaherstory) ![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)
...
## Examples:
```{r, warning=FALSE, message=FALSE, fig.path="man/figures/"}
library(wnbaherstory)
