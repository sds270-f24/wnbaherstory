---
title: "Introduction to wnbaherstory package"
...
The goal of this package is to help users to learn more about WNBA trends and see the overall change in the league since it was founded. Additionally we hope that user can find the answers for their questions about the evolution of WNBA. 
...
Here is an example of how the user can use this function: 
```{r}
career_ppg()
```
...
Here is an example of how the user can use this function: 
```{r}
plot_wnba_attendance("Chicago Sky")
```
...
Here is an example of how the user can use this function: 
```{r}
map_WNBA_teams(year_range = 2020:2024)
```
