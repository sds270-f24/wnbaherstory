...
The goal of this package is to help users to learn more about WNBA trends and see the overall change in the league since it was founded. Additionally we hope that user can find the answers for their questions about the evolution of WNBA. This article will provide you with all the information about each function taht you will need in order to use it. 
...
## map_WNBA_teams
Function shows map of all WNBA teams past and present at any given time. Any of the existing teams can be used as an input.m
